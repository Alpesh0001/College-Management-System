...
class ChangePasswordActivity : CoreBaseActivity() {
    ...
    private lateinit var tvForgotPassword: android.widget.TextView  // ✅ Forgot link
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        facultyDocId = session.getFacultyId() ?: ""
    ...
    private fun bindViews() {
        ...
        tvForgotPassword    = findViewById(R.id.tvForgotPassword)  // ✅ Forgot link
    }
